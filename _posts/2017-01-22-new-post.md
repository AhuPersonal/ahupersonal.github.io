...
The team (ING Bank, Microsoft, Delft University of Technology) behind this project performed a collaborative work. ING initialized it, Microsoft provided the software and Delft was responsible for the input data. 346 paintings were analyzed in detailed to determine the new subject to take place in the new painting. It was pure data analysis detemining the proportion of the shapes of the subject's features. At this point, deep algorithms were used to recreate his style accurately. Computed data was then turned into the 3d printer crafted masterpiece.
