...
Although, this pseudo-creativity brought along many controversial discussions, I think this will inspire people to explore the data more. When I first heard about this project, I just remembered the evolution of the paintings through photography and movie. I thought that if algorithms can learn this and touch the real life so closely as in this case, there is no reason not to make a film once fed with enough data. I believe that the development in the web clouding and machine learning fields will break the chains and accelare the progress of creative algorithms.
